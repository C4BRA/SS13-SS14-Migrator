...
function parseDm(body) {
    const collector = new diagnostics_js_1.DiagnosticCollector();
    const parser = new dmParser_js_1.DMParser(new dmLexer_js_1.DMLexer(body).tokenize(), collector);
    return parser.parse();
}
...
/datum/symbol_base/symbol_child
    proc/child_proc()
        return 2
`;
    const table = new symbolTable_js_1.SymbolTable();
    ...
    const table2 = new symbolTable_js_1.SymbolTable();
    ...
    const table3 = new symbolTable_js_1.SymbolTable();
    table3.addTypeDecls(parseDm('/datum/trail/ \n    proc/x()\n        return 1\n/datum/trail\n    proc/y()\n        return 2'));
    check((0, symbolTable_js_1.normalizeTypePath)('/datum/trail/') === '/datum/trail', 'normalizeTypePath strips trailing slash');
    ...
    const table4 = new symbolTable_js_1.SymbolTable();
    ...
    const table5 = new symbolTable_js_1.SymbolTable();
    table5.addTypeDecls(parseDm('/atom/proc/balloon_alert(mob/viewer, text)\n    return 1\n/atom/movable/proc/forceMove(atom/dest)\n    return 1\n/atom/proc/set_light()\n    return 1'));
    check((0, symbolTable_js_1.computeParentPath)('/obj') === '/atom/movable', '/obj parent is /atom/movable');
    check((0, symbolTable_js_1.computeParentPath)('/mob') === '/atom/movable', '/mob parent is /atom/movable');
    check((0, symbolTable_js_1.computeParentPath)('/turf') === '/atom', '/turf parent is /atom');
    check((0, symbolTable_js_1.computeParentPath)('/area') === '/atom', '/area parent is /atom');
