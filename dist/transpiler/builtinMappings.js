...
exports.STUBBED_BUILTINS = exports.MAPPED_BUILTINS = void 0;
exports.transpileBuiltinCall = transpileBuiltinCall;
exports.MAPPED_BUILTINS = ['sleep', 'spawn', 'qdel', 'locate', 'istype', 'ispath', 'prob', 'pick', 'rand',
...
function transpileBuiltinCall(name, args) {
    switch (name) {
        case 'sleep':
