...
class DMIRGenerator {
    ...
    computeParentPath(path) {
        return (0, symbolTable_js_1.computeParentPath)(path);
    }
    ...
    coerceTruthy(val) {
        ...
        if (s === 'true' || s === 'yes' || s === 'on')
            return '1';
        if (s === 'false' || s === 'no' || s === 'off' || s === '')
            return '0';
        return String(val);
    }
}
exports.DMIRGenerator = DMIRGenerator;
